...
class CashOrders extends Component
{
    ...
    public function render()
    {
        ...
        $counts = [
            'all' => Order::where('order_type', OrderType::CASH_PURCHASE->value)->count(),
            'pending' => Order::where('order_type', OrderType::CASH_PURCHASE->value)
                ->where('status', OrderStatus::PENDING->value)
                ->count(),
            'approved' => Order::where('order_type', OrderType::CASH_PURCHASE->value)
                ->where('status', OrderStatus::APPROVED->value)
                ->count(),
            'completed' => Order::where('order_type', OrderType::CASH_PURCHASE->value)
                ->where('status', OrderStatus::COMPLETED->value)
                ->count(),
            'rejected' => Order::where('order_type', OrderType::CASH_PURCHASE->value)
