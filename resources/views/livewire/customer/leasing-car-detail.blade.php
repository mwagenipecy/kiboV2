        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-24 space-y-6">
                    {{-- Pricing Card --}}
                    <div class="bg-white rounded-xl p-6 shadow-sm border-2 kibo-border">
                        ...
                        @auth
                            ...
                            {{-- Apply button --}}
                            @if($canApply)
                                <button wire:click="$dispatch('open-leasing-modal', {leaseId: {{ $lease->id }}})" class="w-full px-6 py-3 kibo-bg text-white font-bold rounded-lg transition-colors mb-3">
