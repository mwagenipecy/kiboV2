<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white border-b border-gray-200 sticky top-0 z-30">
        <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
            <a href="{{ route('trucks.search') }}" class="flex items-center gap-2 text-green-600 hover:text-green-700 font-medium">
                ...
                @if(count($allImages) > 0)
                    @foreach($allImages as $index => $image)
                        <div wire:click="openImageModal({{ $index }})" class="relative aspect-[4/3] bg-gradient-to-br from-gray-200 to-gray-300 rounded-lg overflow-hidden cursor-pointer hover:opacity-90 transition-opacity {{ $index === 0 ? 'md:col-span-2 md:row-span-2 aspect-[16/10]' : '' }}">
                            <img src="{{ asset('storage/' . $image) }}" alt="Truck image {{ $index + 1 }}" class="w-full h-full object-cover">
                            @if($index === 0)
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm">
                    ...
                    <p class="text-sm text-gray-700 mb-4">{{ $truck->entity->name }}</p>
                    @endif
                    
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">{{ $truck->make->name ?? '' }} {{ $truck->model->name ?? '' }}</h1>
                    @if($truck->variant)
                    <p class="text-lg text-gray-700 mb-4">{{ $truck->variant }}</p>
                    @endif
                    
                    <div class="text-4xl font-bold text-gray-900">£{{ number_format($truck->price, 0) }}</div>
                </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 font-semibold">{{ number_format($truck->mileage) }} km</p>
                        </div>
                        @endif
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 font-semibold">{{ $truck->year }}</p>
                        </div>
                        @endif
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 font-semibold">{{ ucfirst($truck->fuel_type) }}</p>
                        </div>
                        @endif
                        ...
                        <div>
                            <div class="flex items-center gap-2 text-gray-600 mb-1">
                                ...
                                <span class="text-sm font-medium">Truck type</span>
                            </div>
                            <p class="text-gray-900 font-semibold">{{ ucfirst($truck->truck_type) }}</p>
                        </div>
                        @endif
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 font-semibold">{{ ucfirst($truck->body_type) }}</p>
                        </div>
                        @endif
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 font-semibold">{{ number_format($truck->engine_cc / 1000, 1) }}L</p>
                        </div>
                        @endif
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 font-semibold">{{ ucfirst($truck->transmission) }}</p>
                        </div>
                        @endif
                        ...
                        <div>
                            <div class="flex items-center gap-2 text-gray-600 mb-1">
                                ...
                                <span class="text-sm font-medium">Cargo capacity</span>
                            </div>
                            <p class="text-gray-900 font-semibold">{{ number_format($truck->cargo_capacity_kg) }} kg</p>
                        </div>
                        @endif
                        ...
                        <div>
                            <div class="flex items-center gap-2 text-gray-600 mb-1">
                                ...
                                <span class="text-sm font-medium">Towing capacity</span>
                            </div>
                            <p class="text-gray-900 font-semibold">{{ number_format($truck->towing_capacity_kg) }} kg</p>
                        </div>
                        @endif
                        ...
                        <div>
                            <div class="flex items-center gap-2 text-gray-600 mb-1">
                                ...
                                <span class="text-sm font-medium">Payload capacity</span>
                            </div>
                            <p class="text-gray-900 font-semibold">{{ number_format($truck->payload_capacity_kg) }} kg</p>
                        </div>
                        @endif
                        ...
                        <div>
                            <div class="flex items-center gap-2 text-gray-600 mb-1">
                                ...
                                <span class="text-sm font-medium">Axle configuration</span>
                            </div>
                            <p class="text-gray-900 font-semibold">{{ $truck->axle_configuration }}</p>
                        </div>
                        @endif
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 font-semibold">{{ ucfirst($truck->color_exterior) }}</p>
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm">
                    ...
                    <div class="text-gray-700 prose max-w-none">
                        ...
                        @else
                            <p>{{ \Illuminate\Support\Str::limit($truck->description, 200) }}</p>
                            @if(strlen($truck->description) > 200)
                            <button wire:click="toggleSection('fullDescription')" class="mt-4 flex items-center gap-2 text-gray-900 hover:text-gray-700 font-medium">
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm">
                    ...
                    <p class="text-gray-600 mb-6">Work out some of the most important costs for this truck before you go ahead</p>
                ...
                {{-- Buying Safely --}}
                <div class="bg-white rounded-xl p-6 shadow-sm">
                    <h2 class="text-2xl font-bold text-gray-900 mb-4">Buying a truck safely</h2>
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-24 space-y-6">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        ...
                        <div class="space-y-3">
                            {{-- Valuation Report --}}
                            <button wire:click="openValuationModal({{ $truckId }})" class="w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors flex items-start gap-3 border border-gray-200 rounded-lg">
                            ...
                            <button wire:click="openFinancingModal({{ $truckId }})" class="w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors flex items-start gap-3 border border-gray-200 rounded-lg">
                            ...
                            {{-- Cash Purchase --}}
                            <button wire:click="openCashPurchaseModal({{ $truckId }})" class="w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors flex items-start gap-3 border border-gray-200 rounded-lg">
                                <svg class="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm">
                        ...
                        <div class="bg-gray-50 px-3 py-1 rounded inline-block mb-4">
                            <span class="text-sm font-medium text-gray-700">{{ $truck->entity->type ?? 'Dealer' }}</span>
                        </div>

                        <p class="text-gray-700 mb-6">{{ $truck->entity->name }}</p>

                        @if($truck->entity->phone)
                        <a href="tel:{{ $truck->entity->phone }}" class="w-full bg-white border-2 border-green-600 text-green-600 py-3 px-6 rounded-full font-semibold hover:bg-green-50 transition-colors flex items-center justify-center gap-2 mb-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="mailto:{{ $truck->entity->email }}" class="w-full bg-green-600 text-white py-3 px-6 rounded-full font-semibold hover:bg-green-700 transition-colors flex items-center justify-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="fixed inset-0 z-[110] flex items-center justify-center bg-black bg-opacity-95 animate-fadeIn" wire:click="closeImageModal">
        ...
        <div class="max-w-6xl max-h-[90vh] mx-auto px-4" wire:click.stop>
            <img src="{{ asset('storage/' . $allImages[$currentImage]) }}" alt="Truck image" class="max-w-full max-h-[90vh] object-contain rounded-lg shadow-2xl">
        </div>
