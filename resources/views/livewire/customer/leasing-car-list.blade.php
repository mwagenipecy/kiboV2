        ...
        <div class="px-6 py-4">
            ...
            <div class="border-b border-gray-200 pb-4 mb-4">
                ...
                <div class="space-y-2 pl-8">
                    ...
                    <label class="flex items-center gap-3 py-2 cursor-pointer hover:bg-gray-50 rounded px-2">
                        <input wire:model.live="sortBy" type="radio" value="payment_low" class="w-4 h-4 text-green-600">
                        <span class="text-gray-700">Payment: Low to High</span>
                    </label>
                    <label class="flex items-center gap-3 py-2 cursor-pointer hover:bg-gray-50 rounded px-2">
                        <input wire:model.live="sortBy" type="radio" value="payment_high" class="w-4 h-4 text-green-600">
                    ...
                    <label class="flex items-center gap-3 py-2 cursor-pointer hover:bg-gray-50 rounded px-2">
                        <input wire:model.live="sortBy" type="radio" value="term_short" class="w-4 h-4 text-green-600">
                ...
                <div class="pl-8 space-y-4">
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input wire:model.live="minPayment" type="number" placeholder="No min" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                        </div>
                        <div>
                            <label class="text-sm text-gray-600 mb-1 block">Max payment</label>
                            <input wire:model.live="maxPayment" type="number" placeholder="No max" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                        </div>
                    </div>
                </div>
                @endif
            ...
            <div class="border-b border-gray-200 pb-4 mb-4">
                ...
                <div class="pl-8 space-y-2">
                    ...
                    <label class="flex items-center gap-3 py-2 cursor-pointer hover:bg-gray-50 rounded px-2">
                        <input wire:model.live="leaseTerm" type="checkbox" value="{{ $term }}" class="w-4 h-4 text-green-600 rounded">
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col">
                ...
                {{-- Action Button --}}
                <div class="px-4 pb-4">
                    <a href="{{ route('cars.lease.detail', $lease->id) }}" class="block w-full px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition-colors text-center">
                        View Details
                    </a>
                </div>
            </div>
