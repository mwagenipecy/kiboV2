<div>
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">Review and approve customer financing applications</p>
    </div>
            ...
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">${{ number_format($order->order_data['loan_amount'] ?? 0, 2) }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('lender.applications.detail', $order->id) }}" class="text-green-600 hover:text-green-900">View Details</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
