<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Register New Dealer</h1>
            <p class="mt-1 text-sm text-gray-500">Fill in the details to register a new dealer entity</p>
        </div>
