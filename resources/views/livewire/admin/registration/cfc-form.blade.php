        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                <h3 class="text-lg font-semibold text-gray-900">
                    {{ $cfcId ? 'Edit CFC' : 'New CFC Registration' }}
                </h3>
                <p class="text-sm text-gray-600 mt-1">Fill in the CFC details below</p>
            </div>
            ...
            <div class="px-6 py-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                            placeholder="CFC Registration Number"
                        >
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="tinNumber" class="block text-sm font-medium text-gray-700 mb-2">
                            TIN Number
                        </label>
                        <input 
                            type="text" 
                            id="tinNumber" 
                            wire:model="tinNumber" 
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end gap-3">
                ...
                >
                    ...
                    <span wire:loading.remove wire:target="save">{{ $cfcId ? 'Update CFC' : 'Create CFC' }}</span>
