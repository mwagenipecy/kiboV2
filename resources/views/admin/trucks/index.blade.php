...
@section('title', 'All Trucks - Admin Dashboard')
...
@section('content')
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">All Trucks</h1>
                <p class="mt-2 text-sm text-gray-600">Manage and view all registered trucks</p>
            </div>
            <a href="{{ route('admin.trucks.create') }}" class="px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg hover:from-green-600 hover:to-green-700 transition-all shadow-sm flex items-center">
    ...
    @livewire('admin.truck-management.truck-list')
@endsection
