...
<a href="{{ route('loan-calculator.index') }}" class="text-sm font-medium {{ request()->routeIs('loan-calculator.index') ? 'text-green-700 font-semibold' : 'text-gray-600' }} hover:text-green-700 transition-colors">Calculate Payment</a>
