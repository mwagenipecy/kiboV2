    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3">
            <div class="space-y-1">
                ...
                <!-- Car Requests -->
                <a href="{{ route('dealer.car-requests') }}" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg {{ request()->routeIs('dealer.car-requests') ? 'text-white bg-gradient-to-r from-green-500 to-green-600 shadow-sm' : 'text-gray-700 hover:bg-green-50 hover:text-green-700' }} transition-colors group">
                    <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('dealer.auctions') }}" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg {{ request()->routeIs('dealer.auctions') ? 'text-white bg-gradient-to-r from-green-500 to-green-600 shadow-sm' : 'text-gray-700 hover:bg-green-50 hover:text-green-700' }} transition-colors group">
                    <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"/>
                    </svg>
                    <span class="menu-text">Auctions</span>
                    @php
                        $activeAuctions = \App\Models\AuctionVehicle::forDealer()->count();
                    @endphp
                    @if($activeAuctions > 0)
                        <span class="ml-auto px-2 py-0.5 text-xs font-semibold text-green-700 bg-green-100 rounded-full menu-text">{{ $activeAuctions }}</span>
                    @endif
                </a>
