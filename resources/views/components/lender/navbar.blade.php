            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-1 border border-gray-200 z-50">
                        <a href="{{ route('lender.profile') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-green-50">Profile</a>
                        <a href="{{ route('lender.settings') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-green-50">Settings</a>
                        <hr class="my-1">
